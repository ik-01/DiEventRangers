#include "DvElements/DvElementAdditionRange.h"
...
#include "DvElements/DvElementBloom.h"
#include "DvElements/DvElementBossName.h"
#include "DvElements/DvElementCameraBlur.h"
...
#include "DvElements/DvElementCameraShake.h"
#include "DvElements/DvElementCameraShakeLoop.h"
#include "DvElements/DvElementCaption.h"
#include "DvElements/DvElementChangeTimeScale.h"
#include "DvElements/DvElementColorContrast.h"
#include "DvElements/DvElementCompositeAnimation.h"
#include "DvElements/DvElementChromaticAberration.h"
#include "DvElements/DvElementCrossFade.h"
#include "DvElements/DvElementCulling.h"
...
#include "DvElements/DvElementLipAnimation.h"
...
#include "DvElements/DvElementShadowMapParam.h"
...
#include "DvElements/DvElementVertexAnimation.h"
...
enum<uint32> DvElementID
{
	...
	ElementID_Bloom = 1000,
	ElementID_DOF = 1001,
	ElementID_ColorContrast = 1002,
	...
	ElementID_CrossFade = 1033,
	ElementID_Weather = 1034,
	ElementID_ShadowMapParam = 1035,
	ElementID_VariablePointLight = 1036,
	ElementID_OpeningLogo = 1037,
	ElementID_AdditionRange = 1038,
...
void ReadElement(DvElementID id)
{
	switch (id)
	{
		...
		case ElementID_CameraShake:					DvElementCameraShake				dvCameraShake;				break;
		...
		case ElementID_Culling:						DvElementCulling					dvCulling;					break;
		case ElementID_NearFarSetting:				DvElementNearFarSettings			dvNearFarSetting;			break;
		case ElementID_UVAnimation:					DvElementUVAnimation				dvUVAnimation;				break;
		case ElementID_VisibilityAnimation:			DvElementVisibilityAnimation		dvVisibilityAnimation;		break;
		...
		case ElementID_SpotlightModel:				DvElementSpotlightModel				dvSpotlight;				break;
		case ElementID_Bloom:						DvElementBloom						dvBloom;					break;
		case ElementID_DOF:							DvElementDOF						dvDOF;						break;
		case ElementID_ColorContrast:				DvElementColorContrast            	dvColorContrast;			break;
		...
		case ElementID_LookAtIK:					DvElementLookAtIK					dvLookAtIK;					break;
		case ElementID_CameraBlur:					DvElementCameraBlur					dvCameraBlur;				break;
		...
		case ElementID_LipAnimation:				DvElementLipAnimation				dvLipAnimation;				break;
		case ElementID_OverrideAsm:					DvElementOverrideAsm				dvOverrideAsm;				break;
		case ElementID_Aura:						DvElementAura						dvAura;						break;
		case ElementID_ChangeTimeScale:				DvElementChangeTimeScale			dvChangeTimeScale;			break;
		case ElementID_CyberSpaceNoise:				DvElementCyberSpaceNoise			dvCyberSpaceNoise;			break;
		case ElementID_AuraRoad:					DvElementAuraRoad					dvAuraRoad;					break;
		case ElementID_ModelClipping:				DvElementModelClipping				dvModelClipping;			break;
		case ElementID_MovieView:					DvElementMovieView					dvMovieView;				break;
		case ElementID_CrossFade:					DvElementCrossFade					dvCrossFade;				break;
		case ElementID_Weather:						DvElementWeather					dvWeather;					break;
		case ElementID_ShadowMapParam:				DvElementShadowMapParam				dvShadowMapParam;			break;
		case ElementID_VariablePointLight:			DvElementVariablePointLight			dvPointLight;				break;
		case ElementID_AdditionRange:				DvElementAdditionRange				dvAdditionRange;			break;
